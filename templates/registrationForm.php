...
<div class="contenaire-inscritpion">
    ...
    <form class="form-inscription" method="POST" action="../controllers/add.php">
        ...
        <div class="div-inscription">
            <label>Mot de passe :</label><input class="input-inscription" type="password" name="password"
                                                placeholder="Mot de passe">
        </div>

        <div class="div-inscription">
            <label>Confirmation de mot de passe :</label><input class="input-inscription" type="password"
