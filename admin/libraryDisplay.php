...
//methode select par
$librarys = $post->findBy(['type' => 'library'], 1000, $post::TABLE);
...
$_SESSION['info']['redirect'] = 'libraryDisplay';
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="services_modification.php?id= <?= $library['id'] ?>"><button type="button" class="btn btn-success">Modifier</button></a>
                                            <a href="?id= <?= $library['id'] ?>"><button type="button" class="btn btn-danger">Supprimer</button></a>
                                        </td>
                                    </tr>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="../controllers/add_blog.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Entrez le titre de votre :</label>
                            ...
                            <div class="mb-3">
                                <label for="message-text" class="col-form-label">Votre text : </label>
                                <textarea class="form-control" id="message-text" rows="10" name="text" required></textarea>
                            </div>

                            <!-- le type pour l'appel à la base de données -->
                            <input name="type" value="library" hidden>
